 ...
 * BUGGY 1.
 * 
 * The problem is that it needs to go into the negatives for false to be returned
 * I'd assemble this into a stack structure. If I can't do that however, parensDepthCounter should be equal to zero
 */
...
//Taking some string of characters representing a mathematical equation
//like (10+22)*332 and returns a list of organized "tokens"
//representing those characters such as
/**
 *
 * [
 * { type: "Open Bracket" },
...
/**
 * Accepts a string of a basic arithmetic operation
